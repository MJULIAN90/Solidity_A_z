...
contract ValoresDeRetorno{
    ...
    function par_impar(uint _a)  pure public returns(bool){
    ...
    function numeros() pure public returns(uint, uint, uint, uint, uint, uint){
        return (1,2,3,4,5,6);
    }
    ...
    function ultimo_valor() pure public returns (uint){
